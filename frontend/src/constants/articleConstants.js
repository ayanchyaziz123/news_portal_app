...
export const ARTICLE_TOP_REQUEST = 'ARTICLE_TOP_REQUEST'
export const ARTICLE_TOP_SUCCESS = 'ARTICLE_TOP_SUCCESS'
export const ARTICLE_TOP_FAIL = 'ARTICLE_TOP_FAIL'


export const ARTICLE_OFFER_REQUEST = 'ARTICLE_OFFER_REQUEST'
export const ARTICLE_OFFER_SUCCESS = 'ARTICLE_OFFER_SUCCESS'
export const ARTICLE_OFFER_FAIL = 'ARTICLE_OFFER_FAIL'

export const ARTICLE_COUPON_REQUEST = 'ARTICLE_COUPON_REQUEST'
export const ARTICLE_COUPON_SUCCESS = 'ARTICLE_COUPON_SUCCESS'
export const ARTICLE_COUPON_FAIL = 'ARTICLE_COUPON_FAIL'
